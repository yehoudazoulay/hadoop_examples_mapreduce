...
import com.opstty.mapper.NbTreesMapper;
import com.opstty.reducer.NbTreesReducer;
...
public class NbTrees {
    public static void main(String[] args) throws Exception {
        ...
        job.setCombinerClass(NbTreesReducer.class);
        job.setReducerClass(NbTreesReducer.class);
